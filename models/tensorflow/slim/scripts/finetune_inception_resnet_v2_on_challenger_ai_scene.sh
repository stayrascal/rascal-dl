...
PRETRAINED_CHECKPOINT_DIR=$BASE_DIR/saved_models/inception_resnet_v2

# Where the pre-trained Inception Resnet V2 checkpoint is saved to.
MODEL_NAME=inception_resnet_v2

# Where the training (fine-tuned) checkpoint and logs will be saved to.
TRAIN_DIR=$BASE_DIR/output/finetune_on_inception_resnet_v2/${MODEL_NAME}

# Where the dataset is saved to.
DATASET_DIR=$BASE_DIR/ai_challenger_scene_train_20170904
