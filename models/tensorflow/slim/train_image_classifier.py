...
# AdadeltaOptimizer
tf.app.flags.DEFINE_float('adadelta_rho', 0.95, 'The decay rate for AdadeltaOptimizer.')
...
tf.app.flags.DEFINE_float('adam_beta1', 0.9,
                          'The exponential decay rate for the 1st moment estimates of AdamOptimizer.')
tf.app.flags.DEFINE_float('adam_beta2', 0.999,
                          'The exponential decay rate for the 2nd moment estimatesof AdamOptimizer.')
